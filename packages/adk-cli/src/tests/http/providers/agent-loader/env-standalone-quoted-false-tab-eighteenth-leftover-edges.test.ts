...
/**
 * Eighteenth leftover (logger/env residual): standalone env.ts quoted `"false"` / `"true"` strip;
 * TAB-only skip; unquoted false assign — mirrors EnvUtils eighteenth after
 * seventeenth trailing-junk / quoted-empty.
 */
describe("standalone env.ts quoted-false / tab / unquoted-false eighteenth leftover", () => {
