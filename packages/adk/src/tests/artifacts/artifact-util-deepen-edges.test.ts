...
describe("artifact-util deepen edges (TOKENMAXX after #153)", () => {
	it('sessionId "0" is truthy and yields session-scoped URI', () => {
	...
	it('sessionId "" is falsy and yields user-scoped URI', () => {
		const uri = getArtifactUri({
			appName: "app",
			userId: "u",
			filename: "f.bin",
	...
	it("allows . and _ in filename but rejects embedded slash", () => {
