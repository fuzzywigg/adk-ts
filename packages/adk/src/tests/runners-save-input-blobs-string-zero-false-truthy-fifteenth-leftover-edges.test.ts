...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #269 / 03ff90a8 after providers; supersedes closed #273/#262): residual after fourteenth `-0`/`NaN`/`[]` — string `"0"` /
