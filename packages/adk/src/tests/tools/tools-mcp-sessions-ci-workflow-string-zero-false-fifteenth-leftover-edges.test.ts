...
/**
 * Fifteenth leftover: reversible workflow assertions for the tools / MCP /
 * sessions Vitest slice. Keeps the providers sixteenth focused gate intact
 * and pins a companion string-zero-false fifteenth gate plus ci.yml coverage.
 */
describe("tools/mcp/sessions ci workflow fifteenth leftover edges", () => {
	...
	it("push.yml keeps sixteenth gate and companion tools/mcp/sessions fifteenth gate", () => {
		...
		expect(push).toContain("sixteenth-leftover-edges");
		expect(push).toContain("string-zero-false-fifteenth-leftover-edges");
