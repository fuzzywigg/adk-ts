 ...
 * Vitest slice. Pins the focused fifteenth leftover gate on push checks
 * plus existing ci.yml `pnpm test` / ADK coverage steps.
 */
describe("tools/mcp ci workflow fifteenth leftover edges", () => {
