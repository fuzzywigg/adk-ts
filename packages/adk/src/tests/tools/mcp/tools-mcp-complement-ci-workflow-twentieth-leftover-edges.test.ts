...
/**
 * Twentieth leftover (HEAVY tip-relaunch residual complement after merged
 * #259 / tip ~0e4d57c): reversible workflow assertions for the tools/mcp
 * residual Vitest slice (PATH/env/maxTokens/messages/filter/schema). Soft
 * pin only — does not retarget push.yml focused gate (auth/memory #258
 * currently pins nineteenth-leftover-edges). Vitest stays on 3.x.
 */
