 ...
 * reversible workflow pins — auth/memory nineteenth still owns focused push.yml
 * filter; tools/mcp residual deepen stays gated via full pnpm test. Vitest
 * remains on 3.x (no 4.x bump). Does not edit .github/workflows.
 */
