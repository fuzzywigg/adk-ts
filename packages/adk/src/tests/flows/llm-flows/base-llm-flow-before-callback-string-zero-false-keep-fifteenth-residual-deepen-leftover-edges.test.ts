...
/**
 * Fifteenth residual deepen (HEAVY tip-relaunch residual after tip 1f70668 (post #282/#284); supersedes closed #281/#285/#273/#262: after-callback pins string `"0"` /
 ...
 */
describe("base-llm-flow before-callback string-zero/false keep fifteenth residual deepen", () => {
	it.each([
		{ label: '"0"', value: "0" },
