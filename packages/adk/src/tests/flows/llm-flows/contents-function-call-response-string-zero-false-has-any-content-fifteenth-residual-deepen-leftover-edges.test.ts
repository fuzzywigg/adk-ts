...
/**
 * Fifteenth residual deepen (HEAVY tip-relaunch residual after tip 1f70668 (post #282/#284); supersedes closed #281/#285/#273/#262: text `"0"`/`"false"` hasAnyContent
 ...
 */
describe("contents functionCall string-zero/false hasAnyContent fifteenth residual deepen", () => {
	it.each([
		{ label: '"0"', value: "0" },
