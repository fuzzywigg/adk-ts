...
/**
 * Fifteenth residual deepen (HEAVY tip-relaunch residual after tip 1f70668 (post #282/#284); supersedes closed #281/#285/#273/#262: before-callbacks string iterate
 ...
 */
describe("base-llm-flow after-callbacks string-zero/false truthy iterate fifteenth residual deepen", () => {
	it.each([
		{ label: '"0"', value: "0" },
