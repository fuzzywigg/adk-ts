...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #254 / 96457a9):
 * reversible workflow assertions for the runners/flows residual Vitest slice.
 * Pins the focused fifteenth leftover gate on push checks plus existing
 * ci.yml `pnpm test` / ADK coverage steps.
 */
