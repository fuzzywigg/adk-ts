...
describe("OpenAiLlm", () => {
	...
	describe("transformSchemaForOpenAi", () => {
		it("lowercases types and walks nested properties/items/anyOf", () => {
		...
		it("maps arrays and returns non-objects unchanged", () => {
			expect(
	...
	describe("functionDeclarationToOpenAiTool", () => {
		it("defaults missing description and transforms parameters", () => {
			expect(
