...
/**
 * Nineteenth leftover (HEAVY tip-relaunch residual after tip 96457a9):
 * reversible workflow assertions for the providers/telemetry Vitest slice.
 * Softened while agents true-asymmetry twenty-first owns the focused filter
 * pin — pins lint/build/test only.
 */
