...
/**
 * Nineteenth leftover: reversible workflow assertions for the providers /
 * telemetry HEAVY residual Vitest slice after tip #248. Pins the focused
 * nineteenth leftover gate on push checks plus existing ci.yml `pnpm test` /
 * ADK coverage steps.
 */
