...
/**
 * Nineteenth leftover (complement open #252 after tip #251): soft reversible
 * workflow pin for the providers/telemetry residual deepen that #252 does not
 * cover. Tip #251 owns the focused `twenty-first-leftover-edges` filter —
 * this slice only asserts lint/build/test stay wired.
 */
