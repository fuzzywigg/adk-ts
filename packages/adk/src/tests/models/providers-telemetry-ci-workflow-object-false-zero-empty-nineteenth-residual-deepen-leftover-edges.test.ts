 ...
 * push.yml filter; providers/telemetry object-false/zero/empty residual
 * deepen stays gated via full pnpm test. Vitest remains on 3.x.
 */
describe("providers/telemetry ci workflow object-false/zero/empty nineteenth residual deepen", () => {
