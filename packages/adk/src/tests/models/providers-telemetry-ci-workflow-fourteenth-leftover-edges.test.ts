...
/**
 * Fourteenth leftover: reversible workflow assertions for the providers /
 * telemetry Vitest slice. Pins existing CI steps that already run `pnpm test`
 * (covers packages/adk) and the report-only ADK coverage job — no new jobs.
 */
describe("providers/telemetry ci workflow fourteenth leftover edges", () => {
