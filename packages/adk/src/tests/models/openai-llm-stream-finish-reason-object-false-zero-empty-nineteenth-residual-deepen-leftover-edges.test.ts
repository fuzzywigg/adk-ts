 ...
 * stream `if (choice.finish_reason)` — boxed-falsy / `"-Infinity"` / `-1`
 * enter final yield (primitive NaN skipped).
 */
describe("openai-llm stream finish-reason object-false/zero/empty nineteenth residual deepen", () => {
	let llm: OpenAiLlm;
	...
	it.each([
		...
		{ label: 'Object("")', finish_reason: Object("") },
