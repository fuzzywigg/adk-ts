 ...
 * `toolCall.index || 0` — `Object(0)` coerces to array slot 0 and emits;
 * `Object(false)` / `Object(NaN)` are truthy non-index keys orphaned by
 * array `for-of` (sibling of Object(true)/"Infinity"/{} orphan).
 */
describe("openai-llm toolCall.index object-false/zero/nan twentieth residual deepen", () => {
	let llm: OpenAiLlm;
	...
	it("Object(0) coerces to slot 0 and emits tool call", async () => {
