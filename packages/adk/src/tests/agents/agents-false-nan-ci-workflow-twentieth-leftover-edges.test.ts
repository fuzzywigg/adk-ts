 ...
 * `"true"` / boolean-true / empty-array / ±Infinity false-NaN residual slice
 * after tip #225/#235. Pins focused twentieth leftover gate on push checks.
 */
describe("agents false-nan ci workflow twentieth leftover edges", () => {
