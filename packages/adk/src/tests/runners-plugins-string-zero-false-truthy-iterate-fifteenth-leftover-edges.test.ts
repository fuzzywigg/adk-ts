...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #269 / 03ff90a8 after providers; supersedes closed #273/#262): twelfth leftover pins classic falsy `plugins || []`
 * coalescing to []. String `"0"` / `"false"` are truthy so Runner forwards
 * them; PluginManager then iterates string characters as plugins.
 */
describe("runners plugins string-zero/false truthy iterate fifteenth leftover", () => {
