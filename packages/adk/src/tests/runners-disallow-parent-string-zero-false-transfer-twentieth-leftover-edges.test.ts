...
/**
 * Twentieth leftover: `_isTransferableAcrossAgentTree` gates on
 * `if (agent.disallowTransferToParent)`. Agent-transfer leftover pins classic
 * falsy as allowed; string `"0"` / `"false"` are truthy so transfer is blocked
 * and Runner falls back to the root agent.
 */
describe("runners disallowTransferToParent string-zero/false twentieth leftover", () => {
