 ...
 * Softened while runners/flows residual fifteenth owns the focused filter
 * pin — pins lint/build/test only so auth/memory nineteenth leftovers stay
 * gated via full `pnpm test`.
 */
