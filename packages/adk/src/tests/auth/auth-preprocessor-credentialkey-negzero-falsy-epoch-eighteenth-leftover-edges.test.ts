 ...
 * 0/false/NaN → epoch arm. SameValueZero residual: `-0` is likewise falsy
 * (`!!(-0)` false) even though `Object.is(-0, 0)` is false → epoch arm.
 */
describe("auth-preprocessor credentialKey negzero falsy-epoch eighteenth leftover", () => {
