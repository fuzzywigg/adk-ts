...
/**
 * Fifteenth residual deepen (HEAVY tip-relaunch residual after tip 1f70668 (post #282/#284); supersedes closed #281/#285/#273/#262: matrix leftover pins classic falsy
 * `newMessage` → `userContent: null` via `newMessage || null`. String `"0"` /
 * `"false"` are truthy so they are kept as `userContent` (not coalesced).
 */
describe("runners newMessage || null string-zero/false keep fifteenth residual deepen", () => {
	it.each([
		{ label: '"0"', value: "0" },
