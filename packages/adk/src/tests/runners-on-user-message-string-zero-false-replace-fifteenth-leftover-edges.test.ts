...
class TruthyOnUserMessagePlugin extends BasePlugin {
	constructor(private readonly value: unknown) {
		super("truthy-on-user-fifteenth");
	}
...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #269 / 03ff90a8 after providers; supersedes closed #273/#262): residual after fourteenth truthy non-Content TypeError
 ...
 */
describe("runners on-user-message string-zero/false replace fifteenth leftover", () => {
