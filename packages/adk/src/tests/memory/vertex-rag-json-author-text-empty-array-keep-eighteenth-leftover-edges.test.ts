...
/**
 * Eighteenth leftover: parsed JSON `author || ""` / `text || ""` —
 * seventeenth keeps boolean `true`. Empty array `[]` / `{}` are truthy and
 * kept as the array/object value (not coalesced to "").
 */
describe("vertex-rag json author/text empty-array keep eighteenth leftover", () => {
	beforeEach(() => {
