 ...
 * rag_resources (distinct from falsy 0/false empty).
 */
describe("vertex-rag corpus string-true / number-one truthy eighteenth leftover", () => {
	...
	it("numeric 0 still rejects (falsy control)", async () => {
