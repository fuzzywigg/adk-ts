...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #269 / 03ff90a8 after providers; supersedes closed #273/#262): rewind residual after fourteenth SameValueZero `-0`/`NaN`
 * — `false` kept (not deleted via `=== null/undefined`); string `"0"`/`"false"`
 * restored when current differs.
 */
describe("runners rewind state false/string-zero fifteenth leftover", () => {
