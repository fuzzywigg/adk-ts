...
/**
 * Fifteenth leftover (HEAVY tip-relaunch residual after tip #269 / 03ff90a8 after providers; supersedes closed #273/#262): twelfth leftover pins classic falsy FR call
 * author → skip findAgent. String `"0"` / `"false"` are truthy so
 * `if (event?.author)` routes via findAgent (missing name → undefined).
 */
describe("runners find-agent FR author string-zero/false fifteenth leftover", () => {
