 ...
 * `"true"` (no opts) → text; ADK_AGENT_BUILDER_WARN=`"true"` does not
 * enable verbose (strict === `"verbose"`); severity=`"true"` falls to warn.
 */
describe("Logger ADK_WARN_FORMAT/AGENT_BUILDER string-true nineteenth leftover", () => {
