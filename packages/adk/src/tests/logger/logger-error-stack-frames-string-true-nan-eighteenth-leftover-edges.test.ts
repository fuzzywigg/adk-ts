 ...
 * #253 did not touch ADK_ERROR_STACK_FRAMES. Residual: `"true"` / `"false"` →
 * Number() NaN (same empty-stack outcome as seventh `"abc"`).
 */
describe("Logger ADK_ERROR_STACK_FRAMES string-true NaN eighteenth leftover", () => {
