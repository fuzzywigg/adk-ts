...
/**
 * Eighteenth leftover (HEAVY tip-relaunch residual after #227 / tip #248):
 * reversible workflow assertions for the logger/env Vitest slice. Softened
 * while agents true-asymmetry twentieth owns the focused filter pin — pins
 * lint/build/test only so logger/env eighteenth leftovers stay gated via
 * full `pnpm test`.
 */
describe("logger/env ci workflow eighteenth leftover edges", () => {
