 ...
 * Softened while agents true-asymmetry twenty-second owns the focused
 * filter pin — pins lint/build/test only so logger/env residual deepen
 * stays gated via full `pnpm test`.
 */
