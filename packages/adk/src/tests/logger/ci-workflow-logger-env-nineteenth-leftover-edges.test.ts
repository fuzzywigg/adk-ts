...
/**
 * Nineteenth leftover (soft after tip #287 auth/memory twentieth retarget):
 * soft reversible workflow pins — tip owns focused
 * `twentieth-leftover-edges` push.yml filter; logger/env nineteenth files
 * stay gated via full pnpm test; no focused-gate steal.
 */
